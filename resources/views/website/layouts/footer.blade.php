...
<footer class="footer">
    <div class="container">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <ul class="footer-contact-list">
                    <li><i class="la la-map-marker" style="color: var(--etp-orange-500); margin-right: 8px;"></i>
                        {{ __('Luxor, Egypt') }}
                    </li>
        ...
        <div class="footer-bottom-section"
            style="border-top: 1px solid rgba(243, 107, 10, 0.22); padding-top: 30px; margin-top: 40px;">
