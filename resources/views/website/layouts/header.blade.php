...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="{{ route('website.home') }}" aria-label="{{ __('Egypt Tour Pro') }}">
            <img class="brand-logo-img logo-dark" src="{{ asset('website/logo/egypt-tour-pro-dark.png') }}"
                alt="{{ __('Egypt Tour Pro') }}" width="200" height="64">
            <img class="brand-logo-img logo-light" src="{{ asset('website/logo/egypt-tour-pro-charcoal.png') }}"
                alt="{{ __('Egypt Tour Pro') }}" width="200" height="64">
        </a>
...
<div class="modern-mobile-menu" id="modernMobileMenu" aria-label="{{ __('Mobile Navigation') }}">
    <div class="mobile-menu-header">
        <div class="mobile-menu-brand">
            <img class="brand-logo-img logo-dark" src="{{ asset('website/logo/egypt-tour-pro-dark.png') }}"
                alt="{{ __('Egypt Tour Pro') }}" width="140" height="46">
            <img class="brand-logo-img logo-light" src="{{ asset('website/logo/egypt-tour-pro-charcoal.png') }}"
                alt="{{ __('Egypt Tour Pro') }}" width="140" height="46">
        </div>
