...
@section('title', admin_t('Add New Trip'))
...
@php
    ...
    $selectedAttractionIds = collect(old('attraction_ids', []))->map(fn($id) => (int) $id)->all();
    ...
    <div class="container-xxl flex-grow-1 container-p-y package-wizard" dir="{{ $isRtl ? 'rtl' : 'ltr' }}">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ admin_t('Add New Trip') }}</li>
            </ol>
        </nav>
            ...
            <div class="wizard-hero">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                    <div>
                        ...
                        <h1 class="wizard-title">{{ admin_t('Add New Trip') }}</h1>
                        <p class="wizard-subtitle">{{ admin_t('Add all trip details step by step, then publish it.') }}</p>
                    </div>
                                    ...
                                    <div class="fields-grid">
                                        <div class="field-span-3 mb-2">
                                            ...
                                            <div id="nile_cruise_category_wrapper" data-tour-type-section="nile_cruise"
                                                style="display: {{ old('package_type') == 'nile_cruise' && old('nile_cruise_type_id') ? 'block' : 'none' }};"
                                                class="mt-3">
                                        ...
                                        <div class="tour-type-conditional"
                                            ...
                                            style="display: {{ in_array(old('package_type'), ['nile_cruise', 'travel_package']) ? 'none' : 'block' }};">
                                    ...
                                    <div class="fields-grid two-up">
                                        ...
                                        <div class="field-span-2">
                                            ...
                                            <textarea id="description" name="description" rows="8"
                                                ...
                                                placeholder="{{ admin_t('Add rich, detailed copy that helps the customer decide.') }}">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="fields-grid">
                                        ...
                                        <div class="field-span-2">
                                            ...
                                            <textarea id="seo_description" name="seo_description" rows="4" class="form-control"
                                                data-counter-max="160">{{ old('seo_description') }}</textarea>
                                    ...
                                    <div class="review-list">
                                        <div class="review-row">
                                            <div class="review-meta">
                                                ...
                                                <small>Confirm title, city, and package type before publishing.</small>
                                            </div>
                                            <button type="button" class="btn btn-wizard-outline"
                                                data-jump-step="1">Edit</button>
                                        </div>
                                        <div class="review-row">
                                            <div class="review-meta">
                                                <strong>Description & Images</strong>
                                                <small>Check short description and featured image.</small>
                                            </div>
                                            <button type="button" class="btn btn-wizard-outline"
                                                data-jump-step="2">Edit</button>
                                        </div>
                                        <div class="review-row">
                                            <div class="review-meta">
                                                <strong>Route & Duration</strong>
                                                <small>Review trip duration and daily itinerary.</small>
                                            </div>
                                            <button type="button" class="btn btn-wizard-outline"
                                                data-jump-step="3">Edit</button>
                                        </div>
                                        <div class="review-row">
                                            <div class="review-meta">
                                                <strong>Pricing & Policies</strong>
                                                <small>Confirm pricing, inclusions, and policies.</small>
                                            </div>
                                            <button type="button" class="btn btn-wizard-outline"
                                                data-jump-step="4">Edit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="wizard-actions">
                        <div>
                            ...
                            <div class="wizard-actions-meta mt-1">
                                Use this button to save a local draft copy in browser.</div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function markStepState() {
                stepButtons.forEach((button, index) => {
                    ...
                    if (badge) {
                        badge.innerHTML = step < currentStep || (step < highestStep && step !==
                            currentStep) ? '<i class="ti ti-check"></i>' : step;
                    }
                });
            }
