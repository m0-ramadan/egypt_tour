...
@section('title', admin_t('Client Inquiries'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="wrapper-card">
            <div class="wrapper-header d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Inquiries {{ $fullName ?: 'Client' }}</h5>
                    <small class="opacity-75">View All Inquiries Related With This Client</small>
                </div>
            ...
            <div class="p-4">
                ...
                @empty
                    <div class="text-center py-5">No There are Inquiries For this Client</div>
                @endforelse
