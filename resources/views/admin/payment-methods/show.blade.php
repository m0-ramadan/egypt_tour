...
@section('title', admin_t('View Payment Method'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="profile-card">
            <div class="profile-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">{{ adminTrans($paymentMethod->name) ?: 'No Name' }}</h4>
                    <small class="opacity-75">{{ $paymentMethod->type ?? '-' }}</small>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.payment-methods.edit', $paymentMethod) }}" class="btn btn-light">Edit</a>
                    <a href="{{ route('admin.payment-methods.index') }}" class="btn btn-outline-light">Back</a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="info-box">
                            ...
                            <div class="info-value">{{ $paymentMethod->is_active ?? true ? 'Enabled' : 'Disabled' }}</div>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="info-box">
                            <div class="info-label">Default</div>
                            <div class="info-value">{{ $paymentMethod->is_default ?? false ? 'Yes' : 'No' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="info-box">
                            <div class="info-label">Settings / Data</div>
