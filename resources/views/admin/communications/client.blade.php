...
@section('title', admin_t('Client Communication Log'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Communication Client</li>
            </ol>
        </nav>

        <div class="main-card">
            <div class="main-header">
                <h5 class="mb-0">Client Communication Log</h5>
                <small class="opacity-75">
                    {{ $client->name ?? ($communication->sender_name ?? 'Client') }}
                </small>
            </div>
            ...
            <div class="content-body">
                ...
                @empty
                    <div class="text-center py-5">No There are Logs For this Client</div>
                @endforelse
            </div>
        </div>
    </div>
